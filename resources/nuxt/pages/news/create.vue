                        ...
                        <div class="panel-content">
                            <form @submit.prevent="onSave()">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <select class="custom-select" @change="selectOption($event)" id="inputGroupSelect02">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="example-input-normal"  v-model="article.description" name="example-input-normal"
                                           class="form-control">
                                </div>
                                <div class="form-group">
                                    <label class="form-label" for="ckeditor">Detail</label>
                                    <textarea class="form-control" v-model="article.detail" id="ckeditor" rows="5"></textarea>
                                </div>
                                <div class="form-group">
